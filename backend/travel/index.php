...
<?php if (!isset($_GET['action'])) {
 $meSQL = "SELECT * FROM travel ORDER BY travel_id asc";
...
?>
  <tr>
	...
	<td class="center" ><?php echo $rs['travel_name']?></td>
    <td class="center"><?php echo $rs['travel_detail']?></td> 
	<td><pre style="padding: 1px;border: 0px;background-color: transparent !important;"><?php echo $rs['travel_detail']?></pre></td>
  </tr>
  <?php } ?>   
  </tbody>
</table>
